...
if __name__=='__main__':
	...
	elif flag==2:  #Statistical Comparison of the Different Poly Degress
		poly_deg_vals = [1,2,3]  #Can be updated to include different poly degress
		bc_DIC = numpy.zeros((len(poly_deg_vals),7))
		mos_DIC = numpy.zeros(len(poly_deg_vals))
		for i in range(len(poly_deg_vals)):
			bc_DIC[i,:] = pickle.load(open('host_coeff_poly_deg(%d)_DIC.pkl' %poly_deg_vals[i],'rb'))
